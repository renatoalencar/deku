...
module Extern : sig
  type t =
    | Func of func_type * (Memory.t -> Value.t list -> Value.t option)
  and func_type = value_type list * value_type option
  and value_type = I32 | I64
...
module Runtime : sig
    ...
    val make : contract:Contract.t -> imports:(Extern.t list) -> t
    ...
    (** [invoke runtime argument] invokes the entrypoint of the contract
        with a given argument, returning the new updated storage..
